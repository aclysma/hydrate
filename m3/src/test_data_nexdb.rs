...
pub fn setup_test_data() -> TestData {
    ...
    linker.register_record_type("Vec4", |builder| {
        builder.add_f32("x");
        builder.add_f32("y");
        builder.add_f32("z");
        builder.add_f32("w");
    ...
    linker.register_record_type("AllFields", |builder| {
        builder.add_nullable("nullable_bool", SchemaDefType::Boolean);
        builder.add_nullable("nullable_vec3", SchemaDefType::NamedType("Vec3".to_string()));
        ...
        builder.add_dynamic_array("dynamic_array_vec3", SchemaDefType::NamedType("Vec3".to_string()));
    }).unwrap();

    linker.register_record_type("Transform", |builder| {
    ...
    let transform_schema_object = db.find_named_type("Transform").unwrap().as_record().unwrap().clone();
