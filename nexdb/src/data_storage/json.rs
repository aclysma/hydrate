...
#[derive(Debug, Serialize, Deserialize)]
struct TreeSourceDataStorageJsonObject {
    object_id: Uuid,
    schema: Uuid,
    schema_name: String,
    prototype: Option<ObjectReference>,
...
#[derive(Debug, Serialize, Deserialize)]
pub struct TreeSourceDataStorageJsonSingleFile {
    objects: Vec<TreeSourceDataStorageJsonObject>,
}

impl TreeSourceDataStorageJsonSingleFile {
    pub fn store_objects_to_string(
        edit_context: &EditContext,
        objects: &[ObjectId],
    ) -> String {
        ...
        for id in sorted_object_ids {
            ...
            let mut stored_object = TreeSourceDataStorageJsonObject {
        ...
        let storage = TreeSourceDataStorageJsonSingleFile {
    ...
    pub fn load_objects_from_string(
        ...
        let reloaded: TreeSourceDataStorageJsonSingleFile = serde_json::from_str(json).unwrap();
