...
pub struct ImportFilesModal {
    ...
    selected_import_location: Option<AssetLocation>,
}
...
impl ModalAction for ImportFilesModal {
    fn draw(&mut self, context: ModalContext) -> ModalActionControlFlow {
        ...
        default_modal_window("Import Files", context, |context, ui| {
                        ...
                        if let Some(extension) = extension {
                            ...
                            if !handlers.is_empty() {
                                ...
                                hydrate_model::pipeline::import_util::recursively_gather_import_operations_and_create_assets(
                                    ...
                                    &self.selected_import_location.unwrap(),
            ...
            // if ui.add_enabled(is_enabled, egui::Button::new("create")).clicked() {
            //     context.action_queue.queue_action(UIAction::NewAsset(AssetName::new(&self.asset_name), self.create_location.clone(), named_schema_type.unwrap()));
            //     control_flow = ModalActionControlFlow::End;
            // }
        });
