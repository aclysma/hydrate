use hydrate_model::{DataSet, DataSetEntry, DataSetResult, DataSetView, DataSetViewMut, F32Field, ObjectId, PropertyPath, SchemaSet, Value};
...
impl Vec3Record {
    pub fn x(&self) -> F32Field { F32Field(self.0.push("x")) }
    pub fn y(&self) -> F32Field { F32Field(self.0.push("y")) }
    pub fn z(&self) -> F32Field { F32Field(self.0.push("z")) }
}
...
impl Vec4Record {
    ...
    pub fn y(&self) -> F32Field { F32Field(self.0.push("y")) }
    pub fn z(&self) -> F32Field { F32Field(self.0.push("z")) }
    pub fn w(&self) -> F32Field { F32Field(self.0.push("w")) }
}

pub struct TransformRecord(PropertyPath);

impl Vec4Record {
    pub fn position(&self) -> Vec3Record { Vec3Record(self.0.push("position")) }
    pub fn rotation(&self) -> Vec4Record { Vec4Record(self.0.push("rotation")) }
    pub fn scale(&self) -> Vec3Record { Vec3Record(self.0.push("scale")) }
}
