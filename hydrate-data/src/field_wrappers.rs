...
pub trait FieldWriter<'a> {
    fn new(property_path: PropertyPath, data_container: &'a Rc<RefCell<DataContainerMut<'a>>>) -> Self;
}
...
pub struct EnumFieldWriter<'a, T: Enum>(pub PropertyPath, Rc<RefCell<DataContainerMut<'a>>>, PhantomData<T>);
...
pub struct NullableFieldWriter<'a, T: FieldWriter<'a>>(pub PropertyPath, Rc<RefCell<DataContainerMut<'a>>>, PhantomData<T>);
...
impl BooleanField {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<bool> {
        Ok(data_container
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: bool) -> DataSetResult<Option<Value>> {
...
impl I32Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<i32> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_i32()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: i32) -> DataSetResult<Option<Value>> {
...
impl I64Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<i64> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_i64()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: i64) -> DataSetResult<Option<Value>> {
...
impl U32Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<u32> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_u32()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: u32) -> DataSetResult<Option<Value>> {
...
impl U64Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<u64> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_u64()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: u64) -> DataSetResult<Option<Value>> {
...
impl F32Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<f32> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_f32()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: f32) -> DataSetResult<Option<Value>> {
...
impl F64Field {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<f64> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_f64()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: f64) -> DataSetResult<Option<Value>> {
...
impl BytesField {
    fn do_get<'a>(property_path: &PropertyPath, data_container: &'a DataContainer<'a>) -> DataSetResult<&'a Vec<u8>> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_bytes()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: Vec<u8>) -> DataSetResult<Option<Value>> {
...
impl StringField {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<String> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_boolean()
            .unwrap()
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: String) -> DataSetResult<Option<Value>> {
...
pub struct DynamicArrayFieldReader<'a, T: FieldReader<'a>>(pub PropertyPath, DataContainer<'a>, PhantomData<T>);
...
pub struct DynamicArrayFieldWriter<'a, T: FieldWriter<'a>>(pub PropertyPath, Rc<RefCell<DataContainerMut<'a>>>, PhantomData<T>);
...
impl<'a, T: FieldWriter<'a>> DynamicArrayFieldWriter<'a, T> {
    ...
    pub fn add_entry(
        ...
        self.1.borrow_mut().add_dynamic_array_override(self.0.path())
    }
}
...
impl AssetRefField {
    fn do_get(property_path: &PropertyPath, data_container: DataContainer) -> DataSetResult<AssetId> {
        Ok(data_container
            .resolve_property(property_path.path())?
            .as_asset_ref()
            .unwrap())
    ...
    fn do_set(property_path: &PropertyPath, data_container: &mut DataContainerMut, value: AssetId) -> DataSetResult<Option<Value>> {
